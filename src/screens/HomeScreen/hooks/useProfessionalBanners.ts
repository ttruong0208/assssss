...
export const useProfessionalBanners = (
  screen:
    | "home"
    | "product"
    | "product-list"
  ...
  useEffect(() => {
    const fetchBanners = async () => {
      try {
        ...
        // Fetch banners cho trang chủ, vị trí giữa (hoặc có thể là "bottom" tùy yêu cầu)
        ...
        console.error("Error fetching professional banners:", err);
      } finally {
        setIsLoading(false);
      }
    };
